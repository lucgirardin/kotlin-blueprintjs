...
external interface IToastProps : IProps, IIntentProps {
    ...
    var icon: dynamic /* Any | JSX.Element? | Boolean? */
        get() = definedExternally
        set(value) = definedExternally
    var message: dynamic /* ReactElement__0? | String? | Number? | Any? | ReactNodeArray? | ReactPortal? | Boolean? */
        get() = definedExternally
        set(value) = definedExternally
...
external open class Toast(props: P, context: Any = definedExternally) : AbstractPureComponent2__1<IToastProps> {
