...
external open class AbstractPureComponent2<P, S, SS>(props: P, context: Any = definedExternally) : PureComponent<P, S, SS> {
...
external open class AbstractPureComponent2__1<P> : AbstractPureComponent2<P, Any, Any>

external open class AbstractPureComponent2__2<P, S> : AbstractPureComponent2<P, S, Any>