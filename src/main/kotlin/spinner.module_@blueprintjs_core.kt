...
external open class Spinner(props: P, context: Any = definedExternally) : AbstractPureComponent2__1<ISpinnerProps> {
    open fun componentDidUpdate(prevProps: ISpinnerProps)
    override fun render(): ReactElement<`T$35`, dynamic /* String | (props: Any) -> React.ReactElement<Any, dynamic /* String | Any */>? | Any */>
    override fun validateProps(__0: ISpinnerProps)
