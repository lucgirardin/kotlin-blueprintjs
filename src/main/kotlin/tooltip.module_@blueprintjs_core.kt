...
external interface ITooltipPropsPartial : IPopoverSharedProps, IIntentProps {
    var content: dynamic /* JSX.Element? | String? */
        get() = definedExternally
        set(value) = definedExternally
...
external open class Tooltip(props: P, context: Any = definedExternally) : AbstractPureComponent2__1<ITooltipProps> {
