...
external interface HTMLTableDataCellElement : HTMLTableCellElement, HTMLElement {
...
external interface HTMLTableHeaderCellElement : HTMLTableCellElement, HTMLElement {
...
external interface PointerEvent : MouseEvent, Event {
    var height: Number
    var isPrimary: Boolean
    var pointerId: Number
    var pointerType: String
...
external interface ReadableStream<R> {
    ...
    fun getReader(options: `T$9`): ReadableStreamBYOBReader
    fun getReader(): ReadableStreamDefaultReader<R>
    fun <T> pipeThrough(__0: `T$10`<R, T>, options: PipeOptions = definedExternally): ReadableStream<T>
...
external interface SVGFEDropShadowElement : SVGElement, SVGFilterPrimitiveStandardAttributes {
    ...
    fun <K : Nothing?> addEventListener(type: K, listener: (self: SVGFEDropShadowElement, ev: Any) -> Any, options: Boolean = definedExternally)
    fun <K : Nothing?> addEventListener(type: K, listener: (self: SVGFEDropShadowElement, ev: Any) -> Any)
    fun <K : Nothing?> addEventListener(type: K, listener: (self: SVGFEDropShadowElement, ev: Any) -> Any, options: AddEventListenerOptions = definedExternally)
    override fun addEventListener(type: String, listener: EventListener, options: Boolean)
    override fun addEventListener(type: String, listener: EventListener)
    override fun addEventListener(type: String, listener: EventListener, options: AddEventListenerOptions)
    override fun addEventListener(type: String, listener: EventListenerObject, options: Boolean)
    override fun addEventListener(type: String, listener: EventListenerObject)
    override fun addEventListener(type: String, listener: EventListenerObject, options: AddEventListenerOptions)
    fun <K : Nothing?> removeEventListener(type: K, listener: (self: SVGFEDropShadowElement, ev: Any) -> Any, options: Boolean = definedExternally)
    fun <K : Nothing?> removeEventListener(type: K, listener: (self: SVGFEDropShadowElement, ev: Any) -> Any)
    fun <K : Nothing?> removeEventListener(type: K, listener: (self: SVGFEDropShadowElement, ev: Any) -> Any, options: EventListenerOptions = definedExternally)
    override fun removeEventListener(type: String, listener: EventListener, options: Boolean)
    override fun removeEventListener(type: String, listener: EventListener)
    override fun removeEventListener(type: String, listener: EventListener, options: EventListenerOptions)
    override fun removeEventListener(type: String, listener: EventListenerObject, options: Boolean)
...
external interface SVGFEFuncAElement : SVGComponentTransferFunctionElement, SVGElement {
...
external interface SVGFEFuncBElement : SVGComponentTransferFunctionElement, SVGElement {
...
external interface SVGFEFuncGElement : SVGComponentTransferFunctionElement, SVGElement {
...
external interface SVGFEFuncRElement : SVGComponentTransferFunctionElement, SVGElement {
...
external interface XPathEvaluatorBase {
    ...
    fun createExpression(expression: String, resolver: `T$11`? = definedExternally): XPathExpression
    fun createNSResolver(nodeResolver: Node): dynamic /* (prefix: String?) -> String? | `T$11` */
    ...
    fun evaluate(expression: String, contextNode: Node, resolver: `T$11`? = definedExternally, type: Number = definedExternally, result: XPathResult? = definedExternally): XPathResult
    fun evaluate(expression: String, contextNode: Node, resolver: `T$11`? = definedExternally): XPathResult
    fun evaluate(expression: String, contextNode: Node, resolver: `T$11`? = definedExternally, type: Number = definedExternally): XPathResult
}
